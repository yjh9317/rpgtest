...
#include "HitboxCollisionShape.generated.h"

/**
 * 
 */
UCLASS(abstract, Category = "Hitbox System", EditInlineNew, Blueprintable)
class RPGSYSTEM_API UHitboxCollisionShape : public UObject
{
	GENERATED_BODY()
...
UCLASS()
class RPGSYSTEM_API UHitboxCollisionShape_Sphere : public UHitboxCollisionShape
{
	GENERATED_BODY()
public:
...
UCLASS()
class RPGSYSTEM_API UHitboxCollisionShape_Box : public UHitboxCollisionShape
{
	GENERATED_BODY()
public:
...
UCLASS()
class RPGSYSTEM_API UHitboxCollisionShape_Capsule : public UHitboxCollisionShape
{
	GENERATED_BODY()
public:
	/**
