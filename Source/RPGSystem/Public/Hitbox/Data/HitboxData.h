...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Projectiles", meta = (UIMin = 1, ClampMin = 1))
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Projectiles", meta = (UIMin = -1, UIMax = 1, ClampMin = -1, ClampMax = 1))
