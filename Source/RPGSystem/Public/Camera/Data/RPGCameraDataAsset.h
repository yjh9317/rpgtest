...
#include "RPGCameraDataAsset.generated.h"
 ...
 * The looking input action needs to have a RPGCameraTurnRateModifier for the camera to decelerate when close to the constraints.
 */
USTRUCT(BlueprintType)
...
struct FRPGCameraFocusSettings
{
	...
	TObjectPtr<class URPGFocusTargetMethod> FocusTargetMethod;
};
...
struct FRPGCameraSettingsWithGetActorsMethod
{
	...
	TObjectPtr<class URPGGetActorsMethod> GetActorsMethod;
};
 ...
 */
USTRUCT(BlueprintType)
struct FRPGCameraSettingsWithGetActorLocationMethod
{
	GENERATED_BODY()
	...
	TObjectPtr<class URPGFocusTargetMethod> GetActorLocationMethod;
};
...
struct FCameraDitheringSettings
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RPG Camera Dithering")
	FName IgnoreDitheringTag = "RPGIgnoreDithering";

	// Whether we should dither the child actors attached to the obstacle.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RPG Camera Dithering|Collisions")
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Collision")
	FName IgnoreCameraCollisionTag = "RPGIgnoreCameraCollision";
};
 ...
 */
UCLASS(abstract, Category = "RPG|Add On|Settings", EditInlineNew, Blueprintable)
class RPGSYSTEM_API URPGCameraAddOnModifierSettings : public UObject
{
	GENERATED_BODY()
public:
};
...
class URPGCameraDataAssetBase : public UPrimaryDataAsset
{
	GENERATED_BODY()
public:
	/**
	...
	/**
	 * The settings of the camera pitch contraints. This is useful to limit how much the character can look up/down. AAA games usually do not allow the entire 180 degrees range.
	 * The looking input action needs to have a RPGCameraSlowDownInputModifier for the camera to decelerate when close to the constraints.
	 */
	...
	TArray<TObjectPtr<URPGCameraAddOnModifierSettings>> AddOnsSettings;
};