...
public:
	 ...
	 */
	static inline IDialogueSystemEditorModule& Get()
	{
		return FModuleManager::LoadModuleChecked< IDialogueSystemEditorModule >( "DialogueSystemEditor" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "DialogueSystemEditor" );
	}
