...
class DIALOGUESYSTEM_API UDialogueEvents : public UObject
{
	GENERATED_BODY()
...
UCLASS(Blueprintable, BlueprintType, abstract, EditInlineNew, HideCategories = ("DoNotShow"), CollapseCategories, AutoExpandCategories = ("Default"))
class DIALOGUESYSTEM_API UDialogueConditions : public UObject
{
	GENERATED_BODY()
...
class DIALOGUESYSTEM_API UOrCondition : public UDialogueConditions
{
	GENERATED_BODY()
...
// A particular type of condition that nests normal conditions and returns true if at least one of them is true.
UCLASS(NotBlueprintable, BlueprintType, EditInlineNew, HideCategories = ("DoNotShow"), CollapseCategories, AutoExpandCategories = ("Default"))
class DIALOGUESYSTEM_API UAndCondition : public UDialogueConditions
{
	GENERATED_BODY()
...
class DIALOGUESYSTEM_API UDialogue : public UDataAsset
{
	GENERATED_BODY()
